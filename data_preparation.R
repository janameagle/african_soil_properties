...
#### soil bulk density error ########################
# get the soil bulk density
# access and crop 
tif20.bd <- paste0("/vsicurl/https://s3.eu-central-1.wasabisys.com/africa-soil/layers30m/", 
                   c("sol_db_od_md_30m_0..20cm_2001..2017_africa_epsg4326_v0.1.tif"))

tif50.bd <- paste0("/vsicurl/https://s3.eu-central-1.wasabisys.com/africa-soil/layers30m/", 
                   c("sol_db_od_md_30m_20..50cm_2001..2017_africa_epsg4326_v0.1.tif"))
...
coi <- c("Ivory Coast", "Gambia", "Ghana", "Mali", "Niger", "Nigeria", "Senegal", "Togo")
...
for (k in coi) {
  ...
  # save the new cropped raster
  print("writing file")
  writeRaster(bd30m_ctr_msk, paste0("output/", k, "/bulk_density_0m_20m_errors_", k, ".tif"))
  ...
  writeRaster(bd30m_ctr_msk, paste0("output/", k, "/bulk_density_20m_50m_errors_", k, ".tif"))
  print("country done")
}
